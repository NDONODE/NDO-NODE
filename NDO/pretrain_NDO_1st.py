...
#pre-train 1st order NDO
from torch.utils.data import TensorDataset, DataLoader
from sklearn.model_selection import train_test_split
datatmp = np.load('N10k-1st-100-Osin100x3-no1x-irr-10pn.npz')
Nf = datatmp['Nf']
Ndf = Nf[:,2,:]
Nf = Nf[:,:2,:]
...
torch.save(best_model.state_dict(), "N10k-1st-100-Osin100x3-no1x-irr-10pn-LSTM-dt-f-t.pth")
